...
///
/// A copy of the one in `GGChatCoreTests`, which is internal to that target.
/// The alternative was a shared test-support target, which SwiftPM would make
/// a product of the package, and this is thirty lines.
